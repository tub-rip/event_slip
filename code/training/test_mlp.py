...
from models.ann import VisMlpGru
...
class TestCNN3D:
    ...
    def __init__(self, data_dir, sample_file, checkpoint_dir, checkpoint_number, batch_size, hidden_size) -> None:
        self.output_size = 2
        ...
        self.net = self.model(self.hidden_size,self.output_size).to(self.device)
    ...
    def _test(self):
        ...
        # print("loss_sum", test_loss_sum)
        # print('loss batch_size', test_loss_sum/(counter_used_samples/self.batch_size))
...
if __name__ == "__main__":
    ...
    test_cnn3d = TestCNN3D(args.data_dir, args.sample_file, args.checkpoint_dir, args.checkpoint_number, args.batch_size, args.hidden_size)   
    test_cnn3d.run_test()